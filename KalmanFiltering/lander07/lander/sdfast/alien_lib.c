...
#define lasterr (alien_gerror.lasterr_)
#define lastrou (alien_gerror.lastrou_)

alien_gerror_t alien_gerror = {
/* Error parameters
*/
    /* lasterr */ 0,
    /* lastrou */ 0,
    ...
    int errnum)
{
    ...
    fprintf(fnum,"\n");
    if (routine == 1) {
        fprintf(fnum,"alien_grav:\n");
    }
    if (routine == 2) {
        fprintf(fnum,"alien_mass:\n");
    }
    if (routine == 3) {
        fprintf(fnum,"alien_iner:\n");
    }
    if (routine == 4) {
        fprintf(fnum,"alien_btj:\n");
    }
    if (routine == 5) {
        fprintf(fnum,"alien_itj:\n");
    }
    if (routine == 6) {
        fprintf(fnum,"alien_pin:\n");
    }
    if (routine == 7) {
        fprintf(fnum,"alien_init:\n");
    }
    if (routine == 8) {
        fprintf(fnum,"alien_state:\n");
    }
    if (routine == 9) {
        fprintf(fnum,"alien_psstate:\n");
    }
    if (routine == 13) {
        fprintf(fnum,"alien_presacc:\n");
    }
    if (routine == 14) {
        fprintf(fnum,"alien_presvel:\n");
    }
    if (routine == 15) {
        fprintf(fnum,"alien_prespos:\n");
    }
    if (routine == 10) {
        fprintf(fnum,"alien_hinget:\n");
    }
    if (routine == 11) {
        fprintf(fnum,"alien_pointf:\n");
    }
    if (routine == 12) {
        fprintf(fnum,"alien_bodyt:\n");
    }
    if (routine == 17) {
        fprintf(fnum,"alien_deriv:\n");
    }
    if (routine == 16) {
        fprintf(fnum,"alien_resid:\n");
    }
    if (routine == 18) {
        fprintf(fnum,"alien_pseudo:\n");
    }
    if (routine == 19) {
        fprintf(fnum,"alien_mom:\n");
    }
    if (routine == 20) {
        fprintf(fnum,"alien_sys:\n");
    }
    if (routine == 21) {
        fprintf(fnum,"alien_pos:\n");
    }
    if (routine == 22) {
        fprintf(fnum,"alien_vel:\n");
    }
    if (routine == 23) {
        fprintf(fnum,"alien_orient:\n");
    }
    if (routine == 24) {
        fprintf(fnum,"alien_angvel:\n");
    }
    if (routine == 25) {
        fprintf(fnum,"alien_trans:\n");
    }
    if (routine == 26) {
        fprintf(fnum,"alien_perr:\n");
    }
    if (routine == 27) {
        fprintf(fnum,"alien_verr:\n");
    }
    if (routine == 28) {
        fprintf(fnum,"alien_psqdot:\n");
    }
    if (routine == 29) {
        fprintf(fnum,"alien_psudot:\n");
    }
    if (routine == 30) {
        fprintf(fnum,"alien_getht:\n");
    }
    if (routine == 31) {
        fprintf(fnum,"alien_reac:\n");
    }
    if (routine == 32) {
        fprintf(fnum,"alien_acc:\n");
    }
    if (routine == 33) {
        fprintf(fnum,"alien_angacc:\n");
    }
    if (routine == 34) {
        fprintf(fnum,"alien_mult:\n");
    }
    if (routine == 35) {
        fprintf(fnum,"alien_aerr:\n");
    }
    if (routine == 36) {
        fprintf(fnum,"alien_indx:\n");
    }
    if (routine == 37) {
        fprintf(fnum,"alien_pres:\n");
    }
    if (routine == 38) {
        fprintf(fnum,"alien_stab:\n");
    }
    if (routine == 39) {
        fprintf(fnum,"alien_getgrav:\n");
    }
    if (routine == 40) {
        fprintf(fnum,"alien_getmass:\n");
    }
    if (routine == 41) {
        fprintf(fnum,"alien_getiner:\n");
    }
    if (routine == 42) {
        fprintf(fnum,"alien_getbtj:\n");
    }
    if (routine == 43) {
        fprintf(fnum,"alien_getitj:\n");
    }
    if (routine == 44) {
        fprintf(fnum,"alien_getpin:\n");
    }
    if (routine == 45) {
        fprintf(fnum,"alien_getpres:\n");
    }
    if (routine == 46) {
        fprintf(fnum,"alien_getstab:\n");
    }
    if (routine == 47) {
        fprintf(fnum,"alien_info:\n");
    }
    if (routine == 48) {
        fprintf(fnum,"alien_jnt:\n");
    }
    if (routine == 49) {
        fprintf(fnum,"alien_cons:\n");
    }
    if (routine == 50) {
        fprintf(fnum,"alien_assemble:\n");
    }
    if (routine == 51) {
        fprintf(fnum,"alien_initvel:\n");
    }
    if (routine == 52) {
        fprintf(fnum,"alien_static:\n");
    }
    if (routine == 53) {
        fprintf(fnum,"alien_steady:\n");
    }
    if (routine == 54) {
        fprintf(fnum,"alien_motion:\n");
    }
    if (routine == 55) {
        fprintf(fnum,"alien_fmotion:\n");
    }
    if (routine == 56) {
        fprintf(fnum,"alien_equivht:\n");
    }
    if (routine == 57) {
        fprintf(fnum,"alien_massmat:\n");
    }
    if (routine == 58) {
        fprintf(fnum,"alien_frcmat:\n");
    }
    if (routine == 59) {
        fprintf(fnum,"alien_rel2cart:\n");
    }
    if (routine == 60) {
        fprintf(fnum,"alien_comptrq:\n");
    }
    if (routine == 61) {
        fprintf(fnum,"alien_fulltrq:\n");
    }
    if (routine == 62) {
        fprintf(fnum,"alien_vrot:\n");
    }
    if (errnum == 1) {
    ...
    if (errnum == 22) {
        fprintf(fnum,"alien_init must be called first\n");
    }
    if (errnum == 23) {
        fprintf(fnum,"alien_state must be called first\n");
    }
    if (errnum == 24) {
        fprintf(fnum,"alien_deriv must be called first\n");
    }
    if (errnum == 25) {
...
void alien_printerr(FILE *fnum)
{
    ...
    alien_prerrmsg(fnum,lastrou,lasterr);
}
    ...
    double x[])
{
    ...
    alien_ldubsl(n,na,map,l,b,work);
    alien_ldubsd(n,na,map,d,work,work);
    alien_ldubsu(n,na,map,l,work,x);
}

void alien_lduslv(int n,
    int na,
    int map[],
    double tol,
    double work1[],
    ...
    double x[])
{
    ...
    alien_ldudcomp(n,na,map,tol,work1,work2,m,l,d);
    alien_ldubslv(n,na,map,work2,l,d,b,x);
}
    ...
    int *rank)
{
    ...
    if (k  !=  0) {
        alien_qrsl(nr,nc,nra,nca,mapr,mapc,k,work,w,qraux,b,x);
    }
    for (j = k; j <= nca-1; j++) {
        x[mapc[j]] = 0.;
    }
    ...
    int *rank)
{
    ...
    alien_qrdcomp(nr,nc,nra,nca,mapr,mapc,w,qraux,jpvt);
    alien_qrbslv(nr,nc,nra,nca,mapr,mapc,tol,work,iwork,w,qraux,jpvt,b,x,rank);
}
    ...
    double x[])
{
    ...
    if (ndes  ==  0) {
        ...
        alien_qrslv(nra,nra,nra,nra,&iw[map],&iw[map],tol,&iw[jpvt],&rw[qraux],&
        ...
        alien_qrslv(dsiz,dsiz,dsiz,dsiz,&iw[map],&iw[map],tol,&iw[jpvt],&rw[
...
/* Utility routines for use with alien_root. */


void alien_calcerrs(double fval[],
    int nfunc,
    int ndes,
    int dnorm,
    double *maxderr,
    ...
    double newerrs[])
{
    ...
    *fcnt = *fcnt+1;
    ...
    alien_calcerrs(newerrs,nfunc,ndes,dnorm,&maxderr,&maxrerr,&derrnorm);
    ...
    int *err)
{
    ...
    *fcnt = *fcnt+1;
    alien_calcerrs(fret,nfunc,ndes,dnorm,&pmaxderr,&pmaxrerr,&pderrnorm);
    crude = 1e-6;
    for (ntrys = 0; ntrys < 2; ntrys++) {
        ...
        for (;;) {
            ...
            alien_calcjac(func,vars,param,nfunc,nvar,lock,crude,fret,&rw[f1]
              ,jw,fcnt,&rw[scale]);
            for (i = 0; i < nfunc; i++) {
                rw[f1+i] = fret[i]*rw[scale+i];
            }
            alien_lsslv(nfunc,nvar,nfunc,nvar,ndes,&iw[mapf],&iw[mapv],qrtol,dw,
              &rw[morerw],&iw[moreiw],jw,&rw[f1],&rw[deltav]);
            for (;;) {
                alien_adjvars(func,vars,param,nfunc,ndes,dnorm,nvar,&rw[deltav]
                  ,step,pmaxrerr,pderrnorm,rtol,fcnt,&rw[guess],&rw[f1]);
                alien_calcerrs(&rw[f1],nfunc,ndes,dnorm,&maxderr,&maxrerr,&
                  derrnorm);
...
/* Utility routine for use with alien_finteg and alien_vinteg.  Work is 2*neq. */


void alien_rk4m(int (*func)(),
    double time,
    double st[],
    double dst0[],
    double param[],
    ...
    int *status)
{
    ...
    ttime = *time;
    if (step > 0.) {
        alien_rk4m(func,ttime,st,dst,param,step,&work[nst],neq,&work[morework],&
    ...
    int *which)
{
    ...
    *err = 0;
    ...
    while (ttime  <  tfin) {
        ...
        nstp = stp;
        for (;;) {
            alien_rk4m(func,ttime,st,dst,param,nstp,&work[xst],neq,&work[
            ...
            if (stp2 < minstep) {
                ...
                alien_rk4m(func,xtime,&work[xst],&work[xdst],param,stp2,&work[
...
void alien_dc2ang(double dircos[3][3],
    double *a1,
    double *a2,
    double *a3)
{
...
void alien_dc2quat(double dircos[3][3],
    double *e1,
    double *e2,
    double *e3,
    double *e4)
...
double 
alien_vnorm(double ivec[3])
{
    double norm;

/* Compute the length (norm) of a vector
*/
    norm = sqrt(alien_vdot(ivec,ivec));
    return norm;
}

void alien_vcopy(double ivec[3],
    double ovec[3])
{
...
void alien_vadd(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void alien_vsub(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void alien_vcross(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
    double tempout[3];
...
*/
    ...
    stheta = sin(theta);
    ctheta = cos(theta);
    alien_vmul(stheta,ivec,isinvec);
    alien_vmul(ctheta,ivec,icosvec);
    norm = 1./norm;
    alien_vmul(norm,rvec,uvec);
    idotu = alien_vdot(ivec,uvec);
    alien_vcross(uvec,isinvec,uxisin);
    dotcos = idotu*(1.-ctheta);
    alien_vaxpy(dotcos,uvec,icosvec,ovec);
    alien_vadd(ovec,uxisin,ovec);
}

void alien_serialno(int *serno)
{
