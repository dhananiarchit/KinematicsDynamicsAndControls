...
[answer,fval,exitflag]=fmincon(@(q0)criterionGradient(q0,target,link_length,min_roll,min_pitch,min_yaw,max_roll,max_pitch,max_yaw),q0,[],[],[],[],lb,ub,@(q0)constraints(q0,link_length,target,obstacles),options);
...
answer = reshape(answer,[length(link_length) 3]);
